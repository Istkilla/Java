...
public class task01 {
   public static void main(String[] args) {
      Notebook notebook1 = new Notebook("Aorus", "16", "2000", "Windows", "black");
      Notebook notebook2 = new Notebook("Asus", "4", "1000", "Linux", "red");
      Notebook notebook3 = new Notebook("Hp", "8", "2000", "Windows", "white");
      Notebook notebook4 = new Notebook("Lenovo", "16", "1000", "Linux", "grey");
      Notebook notebook5 = new Notebook("Huawei", "4", "2000", "Windows", "blue");
   ...
   public static Map<String, String> selectCriteria() {
      ...
      while (true) {
         System.out.println("Для выбора критерия нажмите 'y', если критерии больше не нужны 'n'");
